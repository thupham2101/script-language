...
public class test implements testConstants {
  ...
  static final public void create_action() throws ParseException {
  ...
  static final public void update_action() throws ParseException {
...
// table() appear first, so define the table() above the set_action()
  ...
  static final public void set_action() throws ParseException {
 ...
 Token t;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x30,0x4000,0x610,};
   }
